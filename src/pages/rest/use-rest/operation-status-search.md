...
*  `status` - The operation status:
   ...
   *  `4` = Open
   *  `5` = Rejected
*  `bulk_uuid` - UUID generated by an [asynchronous API request](/rest/use-rest/asynchronous-web-endpoints.md) or [Bulk API request](/rest/use-rest/bulk-endpoints.md).
...
See [Search using REST APIs](/rest/use-rest/performing-searches.md) for more information about the syntax of search requests.
