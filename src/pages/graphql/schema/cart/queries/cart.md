...
For more details about cart item prices and FPT fields in the schema, see the [CartItemPrices](/reference/graphql/latest/index.md#cartitemprices) reference.
