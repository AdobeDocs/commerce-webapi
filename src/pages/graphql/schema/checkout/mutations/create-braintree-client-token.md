...
The [`createBraintreeClientToken`](/reference/graphql/latest/index.md#createbraintreeclienttoken) reference provides detailed information about the types and fields defined in this mutation.
