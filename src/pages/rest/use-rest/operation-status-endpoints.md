...
`bulk_id` | String | UUID generated by an [asynchronous API request](/rest/use-rest/asynchronous-web-endpoints.md) or [Bulk API request](/rest/use-rest/bulk-endpoints.md).
...
`operations_list` | Object | An array containing information about each operation in a bulk or asynchronous request.
`id` | Integer | Identifies the bulk or asynchronous request.
`bulk_uuid` | String |  UUID generated by an [asynchronous API request](/rest/use-rest/asynchronous-web-endpoints.md) or [Bulk API request](/rest/use-rest/bulk-endpoints.md).
