...
The [`generateCustomerToken`](/reference/graphql/latest/mutations.md#generatecustomertoken) reference provides detailed information about the types and fields defined in this mutation.
