...
Attribute | Data Type | Description
--- | --- | ---
`author` | [NegotiableQuoteUser!](#negotiablequoteuser-attributes) | The first and last name of the commenter
...
Attribute | Data Type | Description
--- | --- | ---
`comment_added` | [NegotiableQuoteHistoryCommentChange](#negotiablequotehistorycommentchange-attributes) | The comment provided with a change in the negotiable quote history
`custom_changes` | [NegotiableQuoteCustomLogChange](#negotiablequotecustomlogchange-attributes) | Lists log entries added by third-party extensions
`expiration` | [NegotiableQuoteHistoryExpirationChange](#negotiablequotehistoryexpirationchange-attributes) | The expiration date of the negotiable quote before and after a change in the quote history
`products_removed` | [NegotiableQuoteHistoryProductsRemovedChange](#negotiablequotehistoryproductsremovedchange-attributes) | Lists products that were removed as a result of a change in the quote history
`statuses` | [NegotiableQuoteHistoryStatusesChange](#negotiablequotehistorystatuseschange-attributes) | The status before and after a change in the negotiable quote history
`total` | [NegotiableQuoteHistoryTotalChange](#negotiablequotehistorytotalchange-attributes) | The total amount of the negotiable quote before and after a change in the quote history
...
Attribute | Data Type | Description
--- | --- | ---
`author` | [NegotiableQuoteUser!](#negotiablequoteuser-attributes) | The person who made a change in the status of the negotiable quote
...
`changes` | [NegotiableQuoteHistoryChanges](#negotiablequotehistorychanges-attributes) | The set of changes in the negotiable quote
