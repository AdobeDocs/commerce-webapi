...
The [`handlePayflowProResponse`](/reference/graphql/latest/mutations.md#handlepayflowproresponse) reference provides detailed information about the types and fields defined in this mutation.
