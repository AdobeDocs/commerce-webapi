...
The [`getPayflowLinkToken`](/reference/graphql/latest/index.md#getpayflowlinktoken) reference provides detailed information about the types and fields defined in this query.
