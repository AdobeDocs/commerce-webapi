...
This topic is for Platform-as-a-Service (PaaS) customers only. Adobe Commerce Cloud Services customers must refer to [REST Authentication](./authentication.md) for details on authentication.
...
In Commerce, a third-party application that uses OAuth for authentication is called an [_integration_](../../get-started/create-integration.md). An integration defines which resources the application can access. The application can be granted access to all resources or a customized subset of resources.
