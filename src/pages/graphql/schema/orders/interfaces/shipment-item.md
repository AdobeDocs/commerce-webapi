...
* [Adobe Commerce as a Cloud Service](/reference/graphql/saas/types-q-s.md#shipmentiteminterface)

* [On-Premises/Cloud](/reference/graphql/latest/types-q-s.md#shipmentiteminterface)
