...
The [`updateCustomer`](/reference/graphql/latest/mutations.md#updatecustomer) reference provides detailed information about the types and fields defined in this mutation.
