1. When the buyer clicks a PayPal button, the frontend executes the [`createPaypalExpressToken`](../../../graphql/schema/checkout/mutations/create-paypal-express-token.md) mutation.
