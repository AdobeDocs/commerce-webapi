...
`bulk_id` | String | UUID generated by an [asynchronous API request](/rest/asynchronous-web-endpoints) or [Bulk API request](/rest/bulk-endpoints/).
...
`operations_list` | Object | An array containing information about each operation in a bulk or asynchronous request.
`id` | Integer | Identifies the bulk or asynchronous request.
`bulk_uuid` | String |  UUID generated by an [asynchronous API request](/rest/asynchronous-web-endpoints) or [Bulk API request](/rest/bulk-endpoints/).
