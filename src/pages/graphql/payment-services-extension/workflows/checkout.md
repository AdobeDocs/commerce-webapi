...
![Payment Services sequence diagram](../../../images/graphql/payment-services.png)
...
1. (Optional) If hosted fields and the Signifyd integration are enabled, run [`getPaymentOrder`](../queries/get-payment-order.md).
