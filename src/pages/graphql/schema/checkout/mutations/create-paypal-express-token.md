...
The [`createPaypalExpressToken`](/reference/graphql/latest/mutations.md#createpaypalexpresstoken) reference provides detailed information about the types and fields defined in this mutation.
