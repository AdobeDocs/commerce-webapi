...
[`CustomizableOptionInterface`](/reference/graphql/latest/index.md#customizableoptioninterface) is defined in the `CatalogGraphQl` module, and its attributes can be used in any `products` query. This interface returns basic information about a customizable option and can be implemented by several types of configurable options:
