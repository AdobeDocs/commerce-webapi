...
*  `status` - The operation status:
   ...
   *  `4` = Open
   *  `5` = Rejected
*  `bulk_uuid` - UUID generated by an [asynchronous API request](/rest/asynchronous-web-endpoints) or [Bulk API request](/rest/bulk-endpoints/).
...
See [Search using REST APIs](/rest/performing-searches/) for more information about the syntax of search requests.
