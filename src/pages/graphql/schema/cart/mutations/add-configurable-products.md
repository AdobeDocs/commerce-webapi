...
The [`addConfigurableProductsToCart`](/reference/graphql/latest/index.md#addconfigurableproductstocart) reference provides detailed information about the types and fields defined in this mutation.
