...
Adobe Commerce as a Cloud Service does not support the `categories` query. Use the Catalog Service [`products` query](https://developer.adobe.com/commerce/services/graphql/catalog-service/categories/) instead.
