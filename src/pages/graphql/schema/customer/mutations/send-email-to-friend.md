...
The [`sendEmailToFriend`](/reference/graphql/latest/index.md#sendemailtofriend) reference provides detailed information about the types and fields defined in this mutation.
