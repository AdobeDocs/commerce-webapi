...
The [`categoryList`](/reference/graphql/latest/index.md#categorylist) reference provides detailed information about the types and fields defined in this query.
