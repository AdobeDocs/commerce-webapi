...
The [`deleteCompanyUser`](/reference/graphql/latest/mutations.md#deletecompanyuser) reference provides detailed information about the types and fields defined in this mutation.
