...
The `GroupedProduct` data type implements [ProductInterface](/reference/graphql/latest/types-k-p.md#productinterface) and [PhysicalProductInterface](/reference/graphql/latest/types-k-p.md#physicalproductinterface). As a result, attributes that are specific to grouped products can be used when performing a [products](../../queries/products.md) query. It also implements [RoutableInterface](/reference/graphql/latest/types-q-s.md#routableinterface).
