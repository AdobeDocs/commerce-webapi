...
| [`GiftCartAttributeValue`](types-f-i.md#giftcartattributevalue) |
...
| `payment_method_nonce` - [`String!`](types-q-s.md#string) | The one-time payment token generated by Braintree payment gateway based on payment details (Card, PayPal). Required field to make sale transaction. |
