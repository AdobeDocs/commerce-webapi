...
Adobe Commerce generates a `bulk_uuid` each time it executes an [asynchronous API request](/rest/use_rest/asynchronous-web-endpoints/). You can track the status of an asynchronous operation with the following endpoints:
...
`bulk_id` | String | UUID generated by an [asynchronous API request](/rest/asynchronous-web-endpoints) or [Bulk API request](/rest/use_rest/bulk-endpoints/).
...
`operations_list` | Object | An array containing information about each operation in a bulk or asynchronous request.
`id` | Integer | Identifies the bulk or asynchronous request.
`bulk_uuid` | String |  UUID generated by an [asynchronous API request](/rest/asynchronous-web-endpoints) or [Bulk API request](/rest/use_rest/bulk-endpoints/).
