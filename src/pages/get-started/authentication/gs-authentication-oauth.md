...
In Magento, a third-party application that uses OAuth for authentication is called an [_integration_]( ./create-integration.html ). An integration defines which resources the application can access. The application can be granted access to all resources or a customized subset of resources.
...
[Create an integration]( ./create-integration.html )

[OAuth error codes]( ./authentication/oauth-errors.html )
