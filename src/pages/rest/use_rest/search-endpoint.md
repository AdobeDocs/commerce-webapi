...
Advanced searches can use any condition type to make comparisions, such as `like`, `eq`, or `finset`. See [Search using REST](/rest/use_rest/performing-searches/) describes condition types.
...
[Search using REST](/rest/use_rest/performing-searches/) provides examples that can be used to search for products.
