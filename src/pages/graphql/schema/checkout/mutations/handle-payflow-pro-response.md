...
The [`handlePayflowProResponse`](/reference/graphql/latest/index.md#handlepayflowproresponse) reference provides detailed information about the types and fields defined in this mutation.
